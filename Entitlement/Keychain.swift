...
public struct KeychainItem<Value>
{
    ...
    public var wrappedValue: Value? {
        get {
            ...
            {
            case is Data.Type:
                return try? Keychain.shared.keychain.getData(self.key) as? Value
            case is String.Type:
                return try? Keychain.shared.keychain.getString(self.key) as? Value
            default:
                return nil
            }
        }
        set {
            ...
            {
            case is Data.Type:
                Keychain.shared.keychain[data: self.key] = newValue as? Data
            case is String.Type:
                Keychain.shared.keychain[self.key] = newValue as? String
            default:
                break
            }
        }
...
public final class Keychain
{
    ...
    private static let serviceName = Bundle.main.bundleIdentifier ?? "Entitlement"

    fileprivate let keychain = KeychainAccess.Keychain(service: Keychain.serviceName)
    ...
    @KeychainItem(key: "authStateData")
    public var authStateData: Data?
